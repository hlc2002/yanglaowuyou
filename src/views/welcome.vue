<template>
  <div class="back">
    <el-header height="50px"> 
        <el-tabs style="display: inline-block; margin-right: 40%;"  @tab-click="toLogin">
      ...
      <el-avatar shape="square" :src="squareUrl" style="display: inline-block; margin-bottom: 15px;margin-left: 100px;">
      </el-avatar>
    </el-header>
    <el-dialog title="用户登录" :visible.sync="dialogFormVisible">
            <el-form :model="userForm">
              <el-form-item label="联系电话" :label-width="formLabelWidth">
                <el-input v-model="userForm.phone" autocomplete="off" type="text"></el-input>
              </el-form-item>
            ...
            <div slot="footer" class="dialog-footer">
              <el-button @click="dialogFormVisible = false,dialogFormVisibleAdmin = true">切换类型</el-button>
              <el-button @click="dialogFormVisible = false, dialogFormVisibleRegister = true">注 册</el-button>
    ...
    <el-dialog title="用户注册" :visible.sync="dialogFormVisibleRegister">
              <el-form :model="userForm">
                ...
                <el-form-item label="姓名" :label-width="formLabelWidth">
                    <el-input v-model="userForm.name" autocomplete="off" type="text"></el-input>
                </el-form-item>
                <el-form-item label="密码" :label-width="formLabelWidth">
                  <el-input v-model="userForm.password" autocomplete="off" type="password"></el-input>
                </el-form-item>
              ...
              <div slot="footer" class="dialog-footer">
                <el-button @click="dialogFormVisible = true, dialogFormVisibleRegister = false">返 回</el-button>
    ...
    <el-dialog title="职工登录" :visible.sync="dialogFormVisibleAdmin">
              ...
              <div slot="footer" class="dialog-footer">
                <el-button @click="dialogFormVisibleAdmin = false, dialogFormVisible = true">切换类型</el-button>
                <el-button @click="dialogFormVisible = false, dialogFormVisibleRegisterAdmin = true">注 册</el-button>
    ...
    <el-dialog title="职工注册" :visible.sync="dialogFormVisibleRegisterAdmin">
                ...
                <div slot="footer" class="dialog-footer">
                  <el-button @click="dialogFormVisibleAdmin = true, dialogFormVisibleRegisterAdmin = false">返 回</el-button>
    ...
    <el-footer>
      <el-divider content-position="center">医养结合，只为更好的服务，确保每一位老人实现“养老无忧”！</el-divider>
    </el-footer>
  </div>
</template>
